...
Dashboard Overview
Secure API with JWT
Fully deployed (Frontend and Backend on same service)
...
Serve frontend via backend using Express static middleware
